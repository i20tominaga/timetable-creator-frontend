                      ...
                      <Card>
                        ...
                        <CardContent>
                          <div className="grid w-full items-center gap-4">
                            ...
                            <div>
                              <Label htmlFor="courselength">コマ数</Label>
                              <Select
                                onValueChange={(value) =>
                                  setCurrentCourse({...currentCourse, length: Number(value)})
                                }
                              >
                                        ...
                                        <SheetContent>
                                          ...
                                          {editingCourse && (
                                            <div className="grid gap-4 py-4">
                                              ...
                                              <div className="grid grid-cols-4 items-center gap-4">
                                                <Label htmlFor="courseLength" className="col-span-1 text-right">
                                                  コマ数
                                                </Label>
                                                <Select
                                                  onValueChange={(value) =>
